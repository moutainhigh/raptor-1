...
//        }
        ...
        map.put("sign", resultSign);
        try {
            HttpResult httpResult = httpClientApi.doPostJson(url, JSONObject.toJSONString(map));
            logger.info(httpResult.getData());
            //Thread.sleep(30000);
        } catch (Exception e) {
            logger.error("错误 ", e);
    ...
    public void offlineRepay2() {
        String userCode = "3C8F5F5667F1ACB87264EC9219C8CB02";
         String type = "REPAY";
        //String type = "POSTPONE";
        BigDecimal amount = new BigDecimal("2000.1");
